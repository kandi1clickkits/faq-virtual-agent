...
REM SET PY_LOCATION=D:\kandikits\python\%PY_VERSION%
SET PY_LOCATION=C:\kandikits\python\%PY_VERSION%
REM SET PY_DOWNLOAD_URL=https://www.python.org/ftp/python/3.9.8/python-3.9.8-amd64.exe
SET PY_DOWNLOAD_URL=https://www.python.org/ftp/python/3.8.10/python-%PY_VERSION%-embed-amd64.zip
...
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/faq-virtual-agent/raw/main/requirements.txt
